...
const sustainabilityImagesArray = Array.from(
  ...
  (_, i) => `/sustainability/sign-${i + 1 < 10 ? "0" + (i + 1) : i + 1}.webp`
);
      ...
      <Section className={"bg-primary"}>
        ...
        <Features
          ...
          features={[
            {
              icon: <FaMedal />,
              title: t("Feateurs-Heading-01", { ns: "Home" }),
              description: t("Feateurs-Content-01", { ns: "Home" }),
            },

            {
              icon: <FaThumbsUp />,
              title: t("Feateurs-Heading-02", { ns: "Home" }),
              description: t("Feateurs-Content-02", { ns: "Home" }),
            },

            {
              icon: <RiLeafFill />,
              title: t("Feateurs-Heading-03", { ns: "Home" }),
              description: t("Feateurs-Content-03", { ns: "Home" }),
            },

            {
              icon: <FaGlobe />,
              title: t("Feateurs-Heading-04", { ns: "Home" }),
              description: t("Feateurs-Content-04", { ns: "Home" }),
            },
          ]}
        />
      </Section>
        ...
        <FadeDown>
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8">
            <div className="w-full bg-white">
              <Link
                to={getLocalizedPath("/sectors/handy-paper", currentLanguage)}
            ...
            <div className="w-full bg-white">
              ...
              >
                ...
                <img
                  src="/sectors/Handy Tissue Products.webp"
                  alt="Handy Tissue Products Sector"
                />
              </Link>
              ...
              <div className="p-3">
                ...
                >
                  <b className="text-2xl text-primary">
                    {t("Handy Tissue Products", { ns: "Common" })}
                  </b>
                </Link>
            ...
            <div className="w-full bg-white">
              ...
              >
                ...
                <img
                  src="/sectors/Handy Wet Wipes.webp"
                  alt="Wet Wipes Sector"
                />
              </Link>
      ...
      <Section className="bg-[#f1eeee]">
        <FadeLeft>
          <SectionTitle className="!leading-tight">
            <>
              <p className="text-secondary ">
                {t("Handy-Products-Heading", { ns: "Home" })}
              </p>
              <p className="text-primary">
                {t("Handy-Products-Subheading", { ns: "Home" })}
              </p>
            </>
          </SectionTitle>
        </FadeLeft>
