          ...
          {sub_category ? (
            <>
              ...
              <Link
                ...
                to={getLocalizedPath(
                  `/category/${categoryId}?filter=${sub_category.title}`,
                  currentLanguage
                )}
              >
                {sub_category.title}
            ...
            <Link
              className="text-primary"
              to={getLocalizedPath(`/category/${categoryId}`, currentLanguage)}
            >
              / {categoryName}
            </Link>
          )}
            ...
            <div className="flex justify-between items-center">
              <FadeLeft>
                <button
                  onClick={() =>
                    navigate(
                      getLocalizedPath(`/product/${prev_id}`, currentLanguage)
                    )
                  }
              ...
              <FadeRight>
                <button
                  onClick={() =>
                    navigate(
                      getLocalizedPath(`/product/${next_id}`, currentLanguage)
                    )
                  }
                  className="button flex gap-1 items-center"
