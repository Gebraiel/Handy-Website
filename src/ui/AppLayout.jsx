...
export default function AppLayout() {
  ...
  const otherLinks = [
    {
      title: t("Health & Safety Measures"),
      link: getLocalizedPath("/health", currentLanguage),
    },
    {
      title: t("Customer Support"),
      link: getLocalizedPath("/support", currentLanguage),
    },
    {
      title: t("Our Branches"),
      link: getLocalizedPath("/branches", currentLanguage),
    },
  ];
  const footerMenu = [
