...
export default function Sector({ sector }) {
  ...
  return (
    <div>
          ...
          <div>
            <FadeIn>
              ...
              <Paragraph size="md" className="text-justify m-auto">
                <span
                  dangerouslySetInnerHTML={{ __html: sector.description_one }}
                />
              </Paragraph>
            </FadeIn>
          </div>
        ...
        <Section className="bg-[#f1eeee]">
          <div>
            ...
            <motion.div
              ...
              whileInView="visible"
              viewport={{ once: true }}
              className="grid justify-center grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-7 2xl:gap-10 gap-5 items-stretch 2xl:my-16 my-8"
            >
              {sector.steps.map((stat, index) => (
                <motion.div
                  variants={childrenVairent}
          ...
          {sector.description_two && (
            <div
              className="mb-[50px]"
              dangerouslySetInnerHTML={{ __html: sector.description_two }}
            />
          )}
        </Section>
      )}
      ...
      <Section
        type="fullscreen"
        className="overflow-x-hidden bg-[#f1eeee] px-5"
      >
