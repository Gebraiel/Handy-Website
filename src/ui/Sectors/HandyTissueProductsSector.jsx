      ...
      <Section className="bg-[#f1eeee]">
        <div className="2xl:my-[50px] my-[25px]">
          <FadeIn>
            <SectionTitle className="2xl:mb-5 !leading-tight ">
              <p className=" text-primary">
                {tSectors("Transformation-Process-Heading-01")}
              </p>
              <p className="text-secondary">
                {tSectors("Transformation-Process-Heading-02")}
              </p>
            </SectionTitle>
          ...
          <motion.div
            ...
            whileInView="visible"
            viewport={{ once: true }}
            className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 2xl:gap-10 gap-5 items-stretch 2xl:my-16 my-8"
          >
        ...
        <div className="mb-[50px]">
          <FadeIn>
            ...
            <Paragraph size="md">
              {tSectors("Handy-Tissue-Key-Excellence-Content-01")}
            </Paragraph>
          </FadeIn>
          <ul className="list-disc ps-5">
            <FadeLeft>
              <li>
                <Paragraph size="sm">
                  <b>{tSectors("Advanced-Machinery")}</b> :{" "}
                  {tSectors("Advanced-Machinery-Content")}
                </Paragraph>
              </li>
            </FadeLeft>
            <FadeLeft delay={0.1}>
              <li>
                <Paragraph size="sm">
                  <b>{tSectors("High-Quality-Materials")}</b> :{" "}
                  {tSectors("High-Quality-Materials-Content")}
                </Paragraph>
              </li>
            </FadeLeft>
            <FadeLeft delay={0.2}>
              <li>
                <Paragraph size="sm">
                  <b>{tSectors("Expert-Operators")}</b> :{" "}
                  {tSectors("Expert-Operators-Content")}
                </Paragraph>
              </li>
            </FadeLeft>
            <FadeLeft delay={0.3}>
              <li>
                <Paragraph size="sm">
                  <b>{tSectors("Robust-Quality-Checks")}</b> :{" "}
                  {tSectors("Robust-Quality-Checks-Content")}
                </Paragraph>
              </li>
            </FadeLeft>
          </ul>
      ...
      <Section>
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-3  lg:w-full">
          <FadeIn>
            <div className="p-5 bg-white shadow-md text-center  space-y-5 ">
              <div className="flex flex-col items-center gap-2 justify-center text-sm">
                <img src="/tissue-roll.png" alt="" className="w-12" />{" "}
                <b>{tSectors("Tissue Paper Converting Plant Capacity")}</b>
              </div>

              <Counter counter="10000" />
              <Paragraph size="sm">{tSectors("Tons / Year")}</Paragraph>
            </div>
          </FadeIn>
          ...
          <FadeIn delay={0.1}>
            <div className="p-5 bg-white shadow-md text-center  space-y-5 ">
              <div className="flex flex-col items-center gap-2 justify-center text-sm">
                <FaPeopleGroup className="size-12" />{" "}
                <b>{tSectors("Employee in Converting Plant")}</b>
              </div>

              <Counter counter="150" />
              <Paragraph size="sm">{tSectors("Employee")}</Paragraph>
            </div>
          </FadeIn>
          ...
          <FadeIn delay={0.2}>
            <div className="p-5 bg-white shadow-md text-center  space-y-5 ">
              <div className="flex flex-col items-center gap-2 justify-center text-sm">
                <FaGlobeAmericas className="size-12" />{" "}
                <b>{tSectors("Export Countries in Converting Plant")}</b>
              </div>

              <Counter counter="10" duration={5000} countBy={10} />
              <Paragraph size="sm">{tSectors("Country")}</Paragraph>
            </div>
          </FadeIn>
        </div>
      </Section>
