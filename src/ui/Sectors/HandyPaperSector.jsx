          ...
          <FadeIn>
            <div className="p-5 bg-white shadow-md  text-center space-y-5 ">
              <div className="flex flex-col items-center gap-2 justify-center text-sm">
                ...
                <b>{tSectors("Tissue Paper Mill Capacity")}</b>
              </div>
          ...
          <FadeIn delay={0.1}>
            <div className="p-5 bg-white shadow-md  text-center space-y-5 ">
              <div className="flex flex-col items-center gap-2 justify-center text-sm">
                ...
                <b>{tSectors("Employee in Handy Paper Mill")}</b>
              </div>
              <Counter counter="150" />
          ...
          <FadeIn delay={0.2}>
            <div className="p-5 bg-white shadow-md  text-center space-y-5 ">
              <div className="flex flex-col items-center gap-2 justify-center text-sm">
                ...
                <b>{tSectors("Export Countries in Handy Paper Mill")}</b>
              </div>
              <Counter counter="12" />
