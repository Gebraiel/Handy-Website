    ...
    <>
      <div className="flex lg:flex-row flex-col justify-between gap-14 2xl:mt-32 mt-16 ">
        <div className="lg:w-2/3">
          <div className="">
            ...
            <SectionTitle className="!text-start">
              <p className="text-secondary 2xl:my-5 xl:my-1">
                {" "}
                {t("Vision-Content1")}
              </p>
              <p className="text-primary">{t("Vision-Content2")}</p>
            </SectionTitle>
          </div>
        ...
        <div className=" max-w-[400px] xl:w-[400px] 2xl:w-full m-auto">
          <img
            className="m-auto xl:w-full xl:h-52 2xl:h-auto xl:object-cover"
            src={handy}
            alt=""
          />
        </div>
