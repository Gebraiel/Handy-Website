          ...
          <ul className="py-8 space-y-5">
            ...
            <li className="flex items-center gap-5 text-primary">
              ...
              <Paragraph className="font-medium flex flex-col">
                <a dir="ltr" href="tel:+2034626379">
                  +2 03 4626379
                </a>
                <a dir="ltr" href="tel:+2034626425">
                  +2 03 4626425
                </a>
              </Paragraph>
            </li>
            <li className="flex items-center gap-5 text-primary">
              {isArabic ? (
                <FaPhone className="w-[24px] text-2xl faphone" />
              ) : (
                <FaPhoneAlt className="w-[24px] text-2xl faphoneAlt" />
              )}
              <Paragraph className="font-medium">
            ...
            <li className="flex items-center gap-5 text-primary">
              ...
              <Paragraph className="font-medium flex flex-col">
                <a dir="ltr" href="https://wa.me/+201223990783" target="_blank">
                  +2 01223990783
                </a>
              </Paragraph>
            </li>
        ...
        <div className="">
          ...
          <ul className="py-8 space-y-5">
            ...
            <li className="flex items-center gap-5 text-primary">
              <FaTty className="w-[24px] text-2xl" />
              <Paragraph className="font-medium flex flex-col">
                <a dir="ltr" href="tel:+20238333156">
                  +2 02 38333156
                </a>
              </Paragraph>
            </li>
            ...
            <li className="flex items-center gap-5 text-primary">
              <FaFax className="w-[24px] text-2xl" />
              <Paragraph className="font-medium">
                <a dir="ltr" href="tel:+20238333157">
                  +2 02 38333157
                </a>
              </Paragraph>
            </li>
