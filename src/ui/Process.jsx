  ...
  return (
   <div className="flex flex-wrap justify-center gap-5 items-stretch ">
         ...
         <div className="bg-contain bg-[url('/pattern.png')] lg:basis-[300px] basis-[500px] text-center py-16 px-9 transition-all duration-300">
           ...
           <h4 className="text-2xl font-bold my-5 border-b-2 border-secondary pb-5">Pulping</h4>
         ...
         <div className="bg-contain bg-[url('/pattern.png')] lg:basis-[300px] basis-[500px] text-center py-16 px-9 transition-all duration-300">
           ...
           <h4 className="text-2xl font-bold my-5 border-b-2 border-secondary pb-5">Trusted</h4>
           <p className="text-sm">
         ...
         <div className="bg-contain bg-[url('/pattern.png')] lg:basis-[300px] basis-[500px] text-center py-16 px-9 transition-all duration-300">
           ...
           <h4 className="text-2xl font-bold my-5 border-b-2 border-secondary pb-5">Eco Friendly</h4>
           <p className="text-sm">
         ...
         <div className="bg-contain bg-[url('/pattern.png')] lg:basis-[300px] basis-[500px] text-center py-16 px-9 transition-all duration-300">
           ...
           <h4 className="text-2xl font-bold my-5 border-b-2 border-secondary pb-5">Global Reach</h4>
           <p className="text-sm ">
